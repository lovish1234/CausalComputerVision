...
class TaskCreator(object):
    ...
    # add default parameters for rectangle box
    def add_rectbox(self, width, height,  dynamic=False):
        return self._add_body_from_builder(shapes_lib.Box,
                                           'rectbox',
                                           dynamic,
                                           width=width,
    ...
    def _recolor_objects(self, task_body1, task_body2, over):
        ...
        for body in self.body_list:
            if 'wall' in body.object_type:
                ...
                if body == task_body1:
                    ...
                    # introducing new color for causal
                    if over:
                        body.set_color(_role_to_color_name('DYNAMIC_OBJECT'))
                    else:
                        body.set_color(_role_to_color_name('DYNAMIC_OBJECT_CAUSAL'))
